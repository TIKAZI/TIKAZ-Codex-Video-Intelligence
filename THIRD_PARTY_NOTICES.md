...
This public tree contains TIKAZ-authored workflows, adapters, scripts, templates, and documentation. It does not intentionally vendor code, prose, media, fonts, or templates from the research projects listed below.

Research that materially informed the problem framing includes:
